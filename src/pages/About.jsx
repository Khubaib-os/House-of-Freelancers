...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="w-[90%] md:w-[80%] mx-auto px-4 sm:px-6 text-center bg-black/50 py-12 sm:py-16 rounded-xl">
          <motion.h1
            {...fadeInUp}
     ...
     {/* Founder Section - Updated for Desktop Full Image */}
<section className="py-12 sm:py-16 bg-white">
  <div className="w-[90%] md:w-[80%] mx-auto px-4 sm:px-6">
    <div className="flex flex-col items-center text-center lg:flex-row lg:items-stretch lg:gap-12">
      {/* Content - Left side for desktop */}
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7 }}
        className="w-full lg:w-1/2 order-2 lg:order-1 flex flex-col justify-center"
      >
        <div className="bg-yellow-100 inline-block px-4 py-2 rounded-full text-sm font-medium text-yellow-800 mb-4">
          Founder
        </div>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
          {aboutData.founder.name}
        </h2>
        <blockquote className="text-lg sm:text-xl text-yellow-600 italic border-l-4 border-yellow-500 pl-4 mb-6 leading-relaxed">
      ...
      {/* Image - Right side full image for desktop, circle for mobile */}
      <motion.div
        initial={{ opacity: 0, x: 50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7 }}
      ...
      >
        <div className="flex justify-center lg:justify-end">
          {/* Mobile: Circle Image */}
          <div className="lg:hidden w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-br from-yellow-200 to-amber-200 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
            <img
              src={aboutData.founder.image}
              alt="House of Freelancers Founder"
              className="w-full h-full object-cover rounded-full"
              loading="lazy"
            />
          </div>
          
          {/* Desktop: Full Rectangle Image - More niche position */}
          <div className="hidden lg:block w-full h-96 rounded-2xl overflow-hidden shadow-2xl mt-20">
            <img
              src={aboutData.founder.image}
              alt="House of Freelancers Founder"
...
{/* CEO Section - Updated for Desktop Full Image */}
<section className="py-12 sm:py-16 bg-gray-50">
  <div className="w-[90%] md:w-[80%] mx-auto px-4 sm:px-6">
    <div className="flex flex-col items-center text-center lg:flex-row lg:items-stretch lg:gap-12">
      {/* Image - Left side full image for desktop, circle for mobile */}
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7 }}
        className="w-full lg:w-1/2 order-1 lg:order-1 mb-8 lg:mb-0"
      >
        <div className="flex justify-center lg:justify-start">
          {/* Mobile: Circle Image */}
          <div className="lg:hidden w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
            <img
              src={aboutData.ceo.image}
              alt="House of Freelancers CEO"
              className="w-full h-full object-cover rounded-full"
              loading="lazy"
            />
          </div>
      ...
      {/* Content - Right side for desktop */}
      <motion.div
        initial={{ opacity: 0, x: 50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7 }}
        className="w-full lg:w-1/2 order-2 lg:order-2 flex flex-col justify-center"
      >
        <div className="bg-gray-100 inline-block px-4 py-2 rounded-full text-sm font-medium text-gray-800 mb-4">
          Chief Executive Officer
        </div>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
          {aboutData.ceo.name}
        </h2>
        <blockquote className="text-lg sm:text-xl text-gray-600 italic border-l-4 border-gray-500 pl-4 mb-6 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-8 no-scrollbar overflow-x-auto">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 sm:px-5 sm:py-3 rounded-lg font-medium text-sm sm:text-base transition-all duration-300 whitespace-nowrap ${
                  activeTab === tab.id
          ...
          >
            {activeTab === 'journey' && (
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 leading-tight">Our Journey Since 2019</h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-8">
                  {aboutData.company.achievements.map((stat, index) => (
                    ...
                    >
                      <div className="text-lg sm:text-xl font-bold text-yellow-600 mb-1 leading-tight">{stat.number}</div>
                      <div className="text-xs sm:text-sm text-gray-600 leading-relaxed">{stat.label}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
            ...
            {activeTab === 'expertise' && (
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 leading-tight">Core Expertise (Since 2019)</h3>
                  <div className="space-y-4">
                    {aboutData.company.coreExpertise.map((category, index) => (
                      ...
                      >
                        <summary className="text-base sm:text-lg font-semibold text-gray-900 mb-2 leading-relaxed cursor-pointer">
                          {category.category}
                        </summary>
                        <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-2 mt-3">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 leading-tight">New Expertise (2025 Onward)</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {aboutData.company.newExpertise.map((expertise, index) => (
                      ...
                      >
                        <h4 className="font-semibold text-gray-900 mb-3 text-base sm:text-lg leading-tight">{expertise.title}</h4>
                        <p className="text-sm text-gray-600 mb-3 leading-relaxed">{expertise.description}</p>
                        <div className="flex flex-wrap gap-2">
                          {expertise.technologies.map((tech) => (
                            <span key={tech} className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs leading-relaxed">
                              {tech}
                            </span>
                          ))}
                        </div>
  ...
  <TeamSection />
            ...
            {activeTab === 'mission' && (
              <div className="space-y-8">
                ...
                >
                  <p className="text-sm sm:text-base text-gray-600 max-w-3xl mx-auto leading-relaxed text-justify">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 sm:p-8 rounded-xl">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 leading-tight">Our Vision</h3>
                  <blockquote className="text-base sm:text-lg md:text-xl italic leading-relaxed">
                    &quot;{aboutData.company.vision}&quot;
                  </blockquote>
                </div>
                <div className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white p-6 sm:p-8 rounded-xl">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 leading-tight">Our Mission</h3>
                  <blockquote className="text-base sm:text-lg md:text-xl italic leading-relaxed">
            ...
            {activeTab === 'values' && (
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 leading-tight">Our Core Values</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {aboutData.company.values.map((value, index) => (
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-gray-900 mb-2 text-base sm:text-lg leading-tight">{value.title}</h4>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="w-[90%] md:w-[80%] mx-auto px-4 sm:px-6 text-center">
          <motion.h2
            {...fadeInUp}
          ...
          >
            <a
              href="/contact"
              className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg font-semibold text-sm sm:text-base hover:bg-yellow-600 transition-all duration-300 shadow-md hover:shadow-lg leading-relaxed"
            ...
            <a
              href="/services"
              className="border border-yellow-400 text-yellow-400 px-6 py-3 rounded-lg font-semibold text-sm sm:text-base hover:bg-yellow-400/10 transition-all duration-300 leading-relaxed"
